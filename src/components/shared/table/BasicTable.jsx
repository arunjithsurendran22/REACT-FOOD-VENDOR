...
const BasicTable = ({ columnsProps, dataProps }) => {
  ...
  return (
    <div className="shadow-lg p-4 md:mx-20 my-10 border border-b-gray-300 rounded-md bg-white overflow-x-auto">
              ...
              {headerGroup.headers.map((column) => (
                ...
                >
                  ...
                  <span className="ml-1 ">
                    {column.isSorted ? (
                      column.isSortedDesc ? (
                        <VscArrowCircleDown className="text-viobg-violet-600 hover:bg-violet-900 " />
                      ) : (
                        <VscArrowCircleUp className="text-viobg-violet-600 hover:bg-violet-900" />
                      )
                    ) : (
                      ""
                    )}
      ...
      <div className="mt-4 flex items-center justify-between">
        ...
        <div className="space-x-2">
          <button
            ...
            className="px-2 py-1 rounded-md bg-violet-600 hover:bg-violet-900 text-white"
          >
            {"<<"}
          </button>
          <button
